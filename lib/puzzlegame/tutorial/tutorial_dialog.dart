...
import 'package:sih_brain_games/puzzlegame/data/game_state.dart';
import 'package:sih_brain_games/puzzlegame/data/board_config.dart';
import 'package:sih_brain_games/puzzlegame/board/exit_arrows.dart';
import 'package:sih_brain_games/puzzlegame/puzzle/puzzle_piece.dart';
      ...
      children: [
        ...
        RichText(
          text: TextSpan(
            ...
            children: [
              TextSpan(text: '\nSteps\n', style: header),
              const TextSpan(text: '\nThe game is not timed, but there is a ',style: TextStyle(color: Colors.blueGrey)),
              TextSpan(text: 'step counter', style: em),
              const TextSpan(
                text: ' at the top. Solving the puzzle is already an incredible'
                    " achievement, so don't be stressed about the steps.",style: TextStyle(color: Colors.blueGrey)
              ),
            ],
          ),
        ),
