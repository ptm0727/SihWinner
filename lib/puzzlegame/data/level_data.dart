...
class LevelData {
  ...
  static level1() => [
        ...
        Piece(1, label: '👮🏻', width: 2, height: 1, x: 1, y: 1),
  ...
  static level4() => [
        ...
        Piece(1, label: '👮🏻', width: 2, height: 1, x: 1, y: 4),
        Piece(2, label: '👮🏻', width: 1, height: 2, x: 0, y: 0),
        Piece(3, label: '👮🏻', width: 1, height: 2, x: 3, y: 0),
        Piece(4, label: '👮🏻', width: 1, height: 2, x: 0, y: 2),
        Piece(5, label: '👮🏻', width: 1, height: 2, x: 3, y: 2),
        Piece(6, label: '👮🏻', width: 1, height: 1, x: 1, y: 0),
        Piece(7, label: '👮🏻', width: 1, height: 1, x: 2, y: 0),
        Piece(8, label: '👮🏻', width: 1, height: 1, x: 1, y: 3),
  ...
  static level5() => [
        Piece(0, label: '🕵🏻', width: 2, height: 2, x: 2, y: 2),
        Piece(1, label: '👮🏻', width: 2, height: 1, x: 0, y: 4),
        Piece(2, label: '👮🏻', width: 1, height: 2, x: 0, y: 0),
        Piece(3, label: '👮🏻', width: 1, height: 2, x: 1, y: 0),
        Piece(4, label: '👮🏻', width: 1, height: 2, x: 2, y: 0),
        Piece(5, label: '👮🏻', width: 1, height: 2, x: 3, y: 0),
        Piece(6, label: '👮🏻', width: 1, height: 1, x: 0, y: 2),
        Piece(7, label: '👮🏻', width: 1, height: 1, x: 1, y: 2),
        Piece(8, label: '👮🏻', width: 1, height: 1, x: 0, y: 3),
        Piece(9, label: '👮🏻', width: 1, height: 1, x: 1, y: 3),
      ];

  /// Level 6: a rather difficult level (85 moves)
  static level6() => [
        Piece(0, label: '🕵🏻', width: 2, height: 2, x: 1, y: 0),
        Piece(1, label: '👮🏻', width: 2, height: 1, x: 1, y: 3),
        Piece(2, label: '👮🏻', width: 1, height: 2, x: 0, y: 0),
        Piece(3, label: '👮🏻', width: 1, height: 2, x: 3, y: 0),
        Piece(4, label: '👮🏻', width: 1, height: 2, x: 0, y: 3),
        Piece(5, label: '👮🏻', width: 1, height: 2, x: 3, y: 3),
        Piece(6, label: '👮🏻', width: 1, height: 1, x: 1, y: 2),
        Piece(7, label: '👮🏻', width: 1, height: 1, x: 2, y: 2),
        Piece(8, label: '👮🏻', width: 1, height: 1, x: 0, y: 2),
        Piece(9, label: '👮🏻', width: 1, height: 1, x: 3, y: 2),
      ];

  /// Level 7: a famous layout on wikipedia (116 moves)
  static level7() => [
        Piece(0, label: '🕵🏻', width: 2, height: 2, x: 1, y: 0),
        Piece(1, label: '👮🏻', width: 2, height: 1, x: 1, y: 2),
        Piece(2, label: '👮🏻', width: 1, height: 2, x: 0, y: 0),
        Piece(3, label: '👮🏻', width: 1, height: 2, x: 3, y: 0),
        Piece(4, label: '👮🏻', width: 1, height: 2, x: 0, y: 2),
        Piece(5, label: '👮🏻', width: 1, height: 2, x: 3, y: 2),
        Piece(6, label: '👮🏻', width: 1, height: 1, x: 1, y: 3),
        Piece(7, label: '👮🏻', width: 1, height: 1, x: 2, y: 3),
        Piece(8, label: '👮🏻', width: 1, height: 1, x: 0, y: 4),
        Piece(9, label: '👮🏻', width: 1, height: 1, x: 3, y: 4),
      ];
